...
{
    HAL_I2C_Mem_Write(&MAX30102_I2C_HANDLE, MAX30102_Device_address, addr, 1, &data, 1,
                      HAL_MAX_DELAY);
    return 1;
}
...
{
    uint8_t data = 0;
    HAL_I2C_Mem_Read(&MAX30102_I2C_HANDLE, MAX30102_Device_address, addr, 1, &data, 1,
                     HAL_MAX_DELAY);
    return data;
}
...
void max30102_config(void)
{
    ...
    max30102_write_reg(REG_FIFO_CONFIG,
                       0x0f);  // sample avg = 1, fifo rollover=false, fifo almost full = 17
    max30102_write_reg(REG_MODE_CONFIG,
...
void max30102_read_fifo(void)
{
    ...
    HAL_I2C_Mem_Read(&MAX30102_I2C_HANDLE, MAX30102_Device_address, REG_FIFO_DATA, 1, ach_i2c_data,
                     6, HAL_MAX_DELAY);
